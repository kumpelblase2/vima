module DropdownHelper
  def video_ordering_dropdown_item(display_name, attribute, ordering = 'asc')
    selected = params[:order] == attribute
    current_ordering = params[:dir]
    ordering_attributes = VideoHelper.ordering_options(attribute, selected, ordering, current_ordering)
